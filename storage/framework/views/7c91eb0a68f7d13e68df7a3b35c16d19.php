                     ...
                     <div class="centeredImgEnquire text-left ">
						...
						$product_image = ProductImage::where('product_id',$cartitem['product_id'])->orderby('image_order','asc')->first(); ?>
                           <a href="<?php echo e($product_url); ?>">
                              <div class="imgHolderEnquire" <?php if(!empty($product_image)): ?>
                                 style="background-image: url('<?php echo e(asset('front/assets/images/products/large/'.$product_image['image'])); ?>');"
                                 <?php endif; ?>></div>
                           </a>
                           <div class="rightDescEnquire">
                              ...
                              <a href="<?php echo e(route('removecartproduct',[$cartitem['id']])); ?>"
