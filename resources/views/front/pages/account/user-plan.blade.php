				...
				<div class="alb-date">{{ $plan['discount_percentage'] }}% OFF</div>
					<div class="pricing_inner">
						<div class="pricing-title">
							...
							@if($plan['id'] == '1')
								<p>🔥 Special Launch Offer! 🔥 Plan starts at <strong>₹199</strong> only for the first 100 users ✨ | <span style="color:#005ca6;font-weight:bold">+18% GST applicable</span> | Offer valid till 31st August 2025</p>
							@endif
					...
					<div class="consalt_btn style_two  button-plans">
						<a href="javascript:;" class="plan-purchase-now" data-href="{{ route('adduserplan',[$plan['id']]) }}">Purchase Now<span></span></a>
					</div>
				</div>
			</div>
