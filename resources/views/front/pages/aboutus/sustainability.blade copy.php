            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-12 col-12 order-1 order-sm-2">
                    <div class="about__content pt-0">
                        <h2 class="sec-subtitle" data-aos="fade-up" data-aos-delay="100">Sustainability at NNE
                        </h2>
                        <h3 class="sec-title" data-aos="fade-up" data-aos-delay="200">Beyond Sustainability. Towards Regeneration</h3>
                    </div>
                    <p data-aos="fade-up">At NNE, sustainability is not a checkbox – it’s a transformation. We don’t just reduce impact; we actively restore ecosystems, empower communities and redesign manufacturing for the future</p>
                </div>
            </div>
            <div class="row align-items-center">
